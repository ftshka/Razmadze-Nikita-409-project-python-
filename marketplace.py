...
class HomePage(tk.Frame):
    ...
    def create_widgets(self):
        button1 = tk.Button(
            self, text="Войти как покупатель",
...
class Customer(tk.Frame):
    ...
    def entr(self, entry):
        flag = 0
        with open('/home/ftshka/python/Razmadze-Nikita-409-project-python-/data_customers.txt', 'r') as keys:
...
class Seller(tk.Frame):
    ...
    def entr(self, entry):
        flag = 0
        with open('/home/ftshka/python/Razmadze-Nikita-409-project-python-/data_sellers.txt', 'r') as keys:
            lines = keys.readlines()
            for line in lines:
                if (entry.get() == line[:-1]):
                    self.controller.show_frame(
...
class Sign_up(tk.Frame):
    ...
    def add(self, var, entry):
        if (len(entry.get()) == 0):
            ...
            if (var.get() == 0):
                with open('/home/ftshka/python/Razmadze-Nikita-409-project-python-/data_customers.txt', 'a') as keys:
                    keys.write(entry.get() + '\n')
            else:
                with open('/home/ftshka/python/Razmadze-Nikita-409-project-python-/data_sellers.txt', 'a') as keys:
                    keys.write(entry.get() + '\n')
...
class Customer_page(tk.Frame):
    ...
    def Search(self, entry, tx):
        ...
        if (len(entry.get()) == 0):
            ...
            flag = 0
            i = 1.0
            with open('/home/ftshka/python/Razmadze-Nikita-409-project-python-/data_products.txt', 'r') as prod:
        ...
        if (len(entry1.get()) == 0 or len(entry2.get()) == 0):
            ...
            if (flag == 0):
                ...
                with open('/home/ftshka/python/Razmadze-Nikita-409-project-python-/data_products.txt', 'r') as prod:
                    lines = prod.readlines()
                lines.pop(i)
                with open('/home/ftshka/python/Razmadze-Nikita-409-project-python-/data_products.txt', 'w') as prod:
...
class Seller_page(tk.Frame):
    ...
    def add_product(self, name, price):
        with open('/home/ftshka/python/Razmadze-Nikita-409-project-python-/data_products.txt', 'a') as prod:
